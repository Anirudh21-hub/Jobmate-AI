...
contact_info = st.text_input(
    "Your contact info (to sign the email)", placeholder="Name, Phone Number"
)
...
if is_send_email:
    if (
        ...
        save_to_text_file(
            text_value=extracted_pdf_text, mode="w"
        )  # save pdf in txt file
        save_to_text_file(
            text_value="\nJob Description : \n" + job_description, mode="a"
        )  # save job desctiption in txt file
